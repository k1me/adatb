...
def felhasznalo_create(felhasznalo: schema_felhasznalo.FelhasznaloCreate, db: Session):
    db_felhasznalo = model_felhasznalo.Felhasznalo(felhasznalonev=felhasznalo.felhasznalonev, nev=felhasznalo.nev, jelszo=hash_password(felhasznalo.jelszo))
...
def felhasznalo_login(felhasznalo: schema_felhasznalo.Bejelentkezes, db: Session):
    db_felhasznalo = db.query(model_felhasznalo.Felhasznalo).filter(
