...
def szobatipus_create(szobatipus: schema_szobatipus.SzobaTipusCreate, db: Session):
    db_szobatipus = model_szobatipus.SzobaTipus(
...
def szobatipus_by_megnevezes(megnevezes: str, db: Session):
    db_szobatipus = (
        db.query(model_szobatipus.SzobaTipus)
        .filter(model_szobatipus.SzobaTipus.megnevezes == megnevezes)
        .first()
    )
...
def szobatipus_update(szobatipus: schema_szobatipus.SzobaTipusCreate, db: Session):
    db_szobatipus = (
        db.query(model_szobatipus.SzobaTipus)
        .filter(model_szobatipus.SzobaTipus.megnevezes == szobatipus.megnevezes)
        .first()
    )
